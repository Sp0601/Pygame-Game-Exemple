...
plyer_surf = player_walk[player_index]
player_rect = plyer_surf.get_rect(midbottom = (80,300))
player_grav = 0
...
game_name_surf = test_font.render('Le Coureur', False, (111,196,169))
game_name_rect = game_name_surf.get_rect(center = (400,80))

game_message = test_font.render('Appuie sur la Espace pour courir', False, (111,196,169))
...
while True: 
    ...
    if game_active:    
        ...
        score_message = test_font.render(f'Ton score : {score}', False,(111,196,169))
